...
<html lang="en">
    ...
    <head>
        ...
        <link href="./assets/img/logo.AVIF" rel="icon">
...
<header id="header" style="background:linear-gradient(to bottom,#e7d6c6ba, #1e1e1fcc),  url(./assets/img/contactbg1.AVIF)">
<nav class="navbar fixed-top navbar-expand navbar-light bg-light">
        <div class="container d-flex align-items-center navbar-start">
            <a href="index.html" class="logo mr-auto"><img src="./assets/img/logonbg.AVIF"></a>
